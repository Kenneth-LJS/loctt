  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        className="w-full resize-y overflow-auto whitespace-pre-wrap break-all rounded-md border border-border-default bg-bg-surface px-2.5 py-2 font-mono text-[12px] text-text-primary focus:border-accent focus:outline-2 focus:outline-accent"
      />
