...
export const SETTINGS_SECTIONS: readonly SettingsSection[] = [
  ...
  { id: "statuses", label: "Statuses", group: "Workflow", built: false },
  { id: "priorities", label: "Priorities", group: "Workflow", built: false },
  { id: "task-types", label: "Task types", group: "Workflow", built: false },
  { id: "relationships", label: "Relationships", group: "Workflow", built: false },
  { id: "custom-fields", label: "Custom fields", group: "Workflow", built: false },
  { id: "estimation", label: "Estimation", group: "Workflow", built: false },
  ...
  { id: "calendar", label: "Calendar", group: "Tracker", built: false },
