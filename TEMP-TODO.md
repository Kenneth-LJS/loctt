...
- [ ] **A11Y feature-gaps (A11Y-10, 12, 17, 39)** — remaining: keyboard-operable filtering (A11Y-10, partly built — FilterBar chips already named), sidebar keyboard nav + collapse aria-state (A11Y-12), focus-survives-refetch (A11Y-17), text-zoom-200% reflow (A11Y-39). **[build, one at a time]**
