...
- [ ] **A11Y feature-gaps (A11Y-10, 17, 39)** — remaining: keyboard-operable filtering (A11Y-10, partly built — FilterBar chips already named), focus-survives-refetch (A11Y-17), text-zoom-200% reflow (A11Y-39). **[build, one at a time]**
